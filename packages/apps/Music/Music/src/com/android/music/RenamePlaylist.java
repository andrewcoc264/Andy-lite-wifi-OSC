...
public class RenamePlaylist extends Activity
{
    ...
    public void onCreate(Bundle icicle) {
      ...
      //add by tupingwen for bug:HQ01446275 20151022 Translation playlistname begin
        if(PlaylistBrowserActivity.RECORDING_FILE_SOURCE.equals(mOriginalName)) {
            mOriginalName = getApplicationContext().getString(R.string.fmrecord_playlist_name);        
        }
