    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    /*add by majipeng for bug 572 Translation playlistname begin*/
    public static final String RECORDING_FILE_SOURCE = "FM Recordings";
    /*add by majipeng for bug 572 Translation playlistname end*/
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfoIn) {
      ...
      //add by tupingwen for bug:HQ01446275 20151022 Translation playlistname begin
        String headerTitle = mPlaylistCursor.getString(mPlaylistCursor.getColumnIndexOrThrow(
                MediaStore.Audio.Playlists.NAME));
        if(RECORDING_FILE_SOURCE.equals(headerTitle)) {
        	headerTitle = getApplicationContext().getString(R.string.fmrecord_playlist_name);        
        }
      //add by tupingwen for bug:HQ01446275 20151022 Translation playlistname end
    }
    ...
    static class PlaylistListAdapter extends SimpleCursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            /*add by majipeng for bug 572 Translation playlistname begin*/
            if( RECORDING_FILE_SOURCE.equals(name))
         	   name=context.getString(R.string.fmrecord_playlist_name);
            /*add by majipeng for bug 572 Translation playlistname end*/
            tv.setText(name);
