...
public class MediaAppWidgetProvider extends AppWidgetProvider {
    ...
    private void linkButtons(Context context, RemoteViews views, boolean playerActive) {
        ...
        if (playerActive) {
            ...
            //bug:HQ01463754-zouxin-2015-10-31 modify begin
            views.setContentDescription(R.id.control_play, context.getString(R.string.pause_button));
            //bug:HQ01463754-zouxin-2015-10-31 modify end
        } else {
            ...
            views.setOnClickPendingIntent(R.id.album_appwidget, pendingIntent);
            //bug:HQ01463754-zouxin-2015-10-31 modify begin
            views.setContentDescription(R.id.control_play, context.getString(R.string.play_selection));
            //bug:HQ01463754-zouxin-2015-10-31 modify end
        }
        ...
        //bug:HQ01463754-zouxin-2015-10-31 modify begin
        views.setContentDescription(R.id.control_next, context.getString(R.string.next_button));
        //bug:HQ01463754-zouxin-2015-10-31 modify end
    }
