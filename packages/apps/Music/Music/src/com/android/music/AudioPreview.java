    ...
    private void updatePlayPause() {
        ...
        if (b != null) {
            if (mPlayer.isPlaying()) {
                ...
                //begin HQ01463470 add by jixuesong at 20151028 for playpause button can not read correct
                b.setContentDescription("music pause");
                //end HQ01463470 add by jixuesong at 20151028 for playpause button can not read correct
            } else {
                b.setImageResource(R.drawable.ic_appwidget_music_play);
                //begin HQ01463470 add by jixuesong at 20151028 for playpause button can not read correct
                b.setContentDescription("music play");
                //end HQ01463470 add by jixuesong at 20151028 for playpause button can not read correct
                mProgressRefresher.removeCallbacksAndMessages(null);
            }
        }
